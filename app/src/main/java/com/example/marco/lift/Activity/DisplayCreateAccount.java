...
import com.example.marco.lift.Utility.VolleyController;
import com.example.marco.lift.Utility.JSONObjectRequest;
import com.example.marco.lift.Utility.Utils;
...
public class DisplayCreateAccount extends ActionBarActivity {
    ...
    private String url = "http://cs.sonoma.edu:8025/iWUMBO_DB/register";
        ...
        thread = new Thread(){
            ...
            public void run() {
                try {
                    ...
                    Intent login = new Intent(DisplayCreateAccount.this, Login.class);
    ...
    private void initUI() {
        btn_register = (Button) findViewById(R.id.create_button);
